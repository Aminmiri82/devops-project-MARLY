...
public class SecurityConfig {
    ...
    public OAuth2AuthorizationRequestResolver googleAuthRequestResolver(ClientRegistrationRepository clientRepo) {
        DefaultOAuth2AuthorizationRequestResolver base = new DefaultOAuth2AuthorizationRequestResolver(clientRepo,
    ...
    SecurityFilterChain filterChain(HttpSecurity http,
        ...
        http
                ...
                .oauth2Login(oauth -> oauth
                        ...
                        // After successful OAuth, redirect to saved request (e.g.
                        // /api/google/tasks/link) or homepage
