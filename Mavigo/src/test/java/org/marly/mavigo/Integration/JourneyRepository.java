...
class JourneyRepositoryTest {
    ...
    void testSaveAndFindJourney() {
        ...
        journey.setWheelchairAccessible(true);
        ...
        assertTrue(found.get().isWheelchairAccessible(),
                "Le flag wheelchair devrait être persisté");
    }
    ...
    void testFindWithLegsById() {
        ...
        // When
        Optional<Journey> found = journeyRepository.findWithLegsById(journey.getId());

        // Then
        assertTrue(found.isPresent());
        assertNotNull(found.get().getLegs(), "Les legs ne devraient pas être null");
    }
    ...
    @Test
    @DisplayName("Sauvegarder un journey avec tous les modes activés")
    void testSaveJourney_WithAllModesEnabled_ShouldPersist() {
        // Given
        User user = new User("ext-test4", "test4@example.com", "Test User 4");
        user = userRepository.save(user);
        ...
        journey.setComfortModeEnabled(true);
        journey.setTouristicModeEnabled(true);
        journey.setWheelchairAccessible(true);
        journey.setStatus(JourneyStatus.PLANNED);
        ...
        assertTrue(found.isPresent());
        assertTrue(found.get().isComfortModeEnabled());
        assertTrue(found.get().isTouristicModeEnabled());
        assertTrue(found.get().isWheelchairAccessible());
    }
